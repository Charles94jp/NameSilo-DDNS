...
|email_after_reboot|Linux下，且设置了邮件才有效。默认false，设置为true后，如果系统开机时间到当前时间的间隔小于5分钟，会收到邮件提醒，获得当前IP。<br>适用于家里意外断电的情况，当通电后，路由器重新拨号，一般会获得新IP，如果服务器支持来电自动开机，那么DDNS在开机自动启动后，会发送邮件告诉你：你的服务器已成功启动。|
